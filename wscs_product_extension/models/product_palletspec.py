...
class ProductPalletSpec(models.Model):
    ...
    cases_per_width = fields.Integer(string='Width',default=0)
    cases_per_length = fields.Integer(string='Length',default=0)
    cases_per_height = fields.Integer(string='Height',default=0)
    cases_per_weight = fields.Float(string=' Nett Weight',default=0)
